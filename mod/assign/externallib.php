            ...
            if ($modules = get_coursemodules_in_course('assign', $courses[$id]->id, $extrafields)) {
                foreach ($modules as $module) {
                    ...
                    $assignment = array(
                        ...
                        'preventlateresubmissions' => $module->preventlateresubmissions,
    ...
    private static function get_assignments_assignment_structure() {
        return new external_single_structure(
            array(
                ...
                'preventlateresubmissions' => new external_value(PARAM_INT, 'prevent submission changes after due date'),
