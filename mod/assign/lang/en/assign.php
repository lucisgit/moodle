...
$string['preventlateresubmissions'] = 'Prevent late resubmissions';
$string['preventlateresubmissions_help'] = 'If enabled, students will be unable to make submission changes after the due date has passed, unless an extension has been granted. However, they will still be allowed to submit for the first time provided the cut-off date has not passed.';
